...
letter = "A" #letter shifted
shift = 3 #no of positions shifted to the right
...
print(f"shift_letter: {letter}, {shift} -> ", shifted_letter)
...
letter = "A"  # letters shifted
letter_shift = "F"  # no of positions shifted right 
...
print(f"shift_letter: {letter}, {letter_shift} ->", shifted_letter)
